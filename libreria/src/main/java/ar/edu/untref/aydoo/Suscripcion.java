...
public class Suscripcion extends Producto {
    ...
    private ProductoPeriodico productoSuscripto;
    private TipoSuscripcion tipoSuscripcion;
    private static final BigDecimal porcentajeDescuento = new BigDecimal("20.00");

    public Suscripcion(String descripcion, ProductoPeriodico productoSuscripto, TipoSuscripcion tipoSuscripcion) {
        super(descripcion, productoSuscripto.getPrecio());
